    ...
    <div class="w-full px-5 py-16 md:py-24 text-gray-800">
        <div class="w-full max-w-6xl mx-auto">
            <div class="text-center max-w-xl mx-auto">
                <h1 class="text-6xl md:text-7xl font-bold mb-5 text-blue-300">What people <br>are saying.</h1>
                <h3 class="text-xl mb-5 text-gray-200 font-light">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h3>
