<section class="bg-gray-900 mt-32">
  <div class="container px-6 py-10 mx-auto">
      <div class="lg:flex lg:items-center">
          <div class="w-full space-y-12 lg:w-1/2 ">
              <div>
                  <h1 class="text-3xl font-semibold capitalize lg:text-4xl  text-white">explore our <br> awesome Components</h1>
              ...
              <div class="md:flex md:items-start md:-mx-4">
                  <span class="inline-block p-2 text-blue-500 bg-blue-100 rounded-xl md:mx-4  text-white  bg-blue-500">
                  ...
                  <div class="mt-4 md:mx-4 md:mt-0">
                      <h1 class="text-2xl font-semibold text-gray-300 capitalize  text-white">Copy & paste components</h1>
              ...
              <div class="md:flex md:items-start md:-mx-4">
                  ...
                  <div class="mt-4 md:mx-4 md:mt-0">
                      <h1 class="text-2xl font-semibold text-gray-300 capitalize  text-white">Zero Configrations</h1>
              ...
              <div class="md:flex md:items-start md:-mx-4">
                  ...
                  <div class="mt-4 md:mx-4 md:mt-0">
                      <h1 class="text-2xl font-semibold text-gray-300 capitalize  text-white">elegant Dark Mode</h1>
            ...
            <div class="md:flex md:items-start md:-mx-4">
                ...
                <div class="mt-4 md:mx-4 md:mt-0">
                    ...
                    <p class="mt-3 text-gray-400  text-gray-300">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident ab nulla quod dignissimos vel non corrupti doloribus voluptatum eveniet
                    </p>
                </div>
            </div>
          ...
          <div class="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
              <img class="object-cover xl:w-[34rem] xl:h-[34rem] rounded-xl" src="https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=755&q=80" alt="">
          </div>
      </div>
      <br/>
      <br/>
