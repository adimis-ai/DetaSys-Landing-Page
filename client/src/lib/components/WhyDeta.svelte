...
<div class="px-4 mt-20 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
  <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
    <div>
      <p class="inline-block px-3 py-px mb-4 text-xs font-semibold tracking-wider text-gray-300 uppercase rounded-full bg-teal-accent-400">
        Brand new
      </p>
    </div>
    <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-blue-300 sm:text-4xl md:mx-auto">
  ...
  <div class="grid max-w-screen-lg mx-auto space-y-6 lg:grid-cols-2 lg:space-y-0 lg:divide-x">
    <div class="space-y-6 sm:px-16">
      <div class="flex flex-col max-w-md sm:flex-row">
        ...
        <div>
          <h6 class="mb-3 text-xl text-blue-300 font-bold leading-5">The deep ocean</h6>
      ...
      <div class="flex flex-col max-w-md sm:flex-row">
        ...
        <div>
          <h6 class="mb-3 text-xl text-blue-300 font-bold leading-5">When has justice</h6>
          <p class="text-sm text-gray-100">
      ...
      <div class="flex flex-col max-w-md sm:flex-row">
        ...
        <div>
          <h6 class="mb-3 text-xl text-blue-300 font-bold leading-5">Leverage agile</h6>
          <p class="text-sm text-gray-100">
    ...
    <div class="space-y-6 sm:px-16">
      <div class="flex flex-col max-w-md sm:flex-row">
        ...
        <div>
          <h6 class="mb-3 text-xl text-blue-300 font-bold leading-5">Organically grow</h6>
          <p class="text-sm text-gray-100">
      ...
      <div class="flex flex-col max-w-md sm:flex-row">
        ...
        <div>
          <h6 class="mb-3 text-xl font-bold text-blue-300 leading-5">Have a good one</h6>
          <p class="text-sm text-gray-100">
      ...
      <div class="flex flex-col max-w-md sm:flex-row">
        ...
        <div>
          <h6 class="mb-3 text-xl font-bold text-blue-300 leading-5">A slice of heaven</h6>
          <p class="text-sm text-gray-100">
